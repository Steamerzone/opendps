...
#define FONT_METER_LARGE_MAX_GLYPH_HEIGHT (22)
#define FONT_METER_LARGE_MAX_GLYPH_WIDTH  (22)
#define FONT_METER_LARGE_MAX_DIGIT_WIDTH  (12)
#define FONT_METER_LARGE_DOT_WIDTH        (4)
#define FONT_METER_LARGE_SPACING          (4)
#define FONT_METER_LARGE_SPACE_WIDTH      (6)
...
extern const uint8_t font_meter_large_pixdata[860];
